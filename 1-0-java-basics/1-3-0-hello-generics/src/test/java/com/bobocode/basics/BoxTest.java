...
import com.bobocode.basics.v1.Box;
...
public class BoxTest {
    ...
    void boxClassHasOneTypeParameter() {
        var typeParameters = com.bobocode.basics.v1.Box.class.getTypeParameters();
    ...
    void typeParameterIsCalledT() {
        var typeParameter = com.bobocode.basics.v1.Box.class.getTypeParameters()[0];
    ...
    void valueFieldIsGeneric() {
        var valueField = com.bobocode.basics.v1.Box.class.getDeclaredField("value");
    ...
    void constructorParameterIsGeneric() {
        var constructor = com.bobocode.basics.v1.Box.class.getDeclaredConstructors()[0];
    ...
    void getterReturnTypeIsGeneric() {
        var getter = com.bobocode.basics.v1.Box.class.getDeclaredMethod("getValue");
